...
def test_upload():
    ...
    c.setopt(pycurl.HTTPPOST, [('file', (pycurl.FORM_FILE, "static/img/images/7-action-athlete-896567.jpg"))])
    ...
    assert response['file_name'] == 'static/img/images/MAX-7-action-athlete-896567.jpg'
